...
test('it returns stega encoded source maps', async () => {
  ...
  expect(vercelStegaDecode(resultArray[0].title)).toMatchInlineSnapshot(
    `
    {
      "href": "https://preview-kit-test-studio.sanity.build/intent/edit/id=0074e292-efcf-45c2-aeb8-f680da2277ff;type=page;path=title?baseUrl=https%3A%2F%2Fpreview-kit-test-studio.sanity.build&id=0074e292-efcf-45c2-aeb8-f680da2277ff&type=page&path=title",
      "origin": "sanity.io",
    }
  `,
  )
...
test('it can access the original source map', async () => {
  ...
  expect(vercelStegaDecode(result)).toMatchInlineSnapshot(`
    {
      "href": "/studio/intent/edit/id=0074e292-efcf-45c2-aeb8-f680da2277ff;type=page;path=title?baseUrl=%2Fstudio&id=0074e292-efcf-45c2-aeb8-f680da2277ff&type=page&path=title",
      "origin": "sanity.io",
    }
  `)
